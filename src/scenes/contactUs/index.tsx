   ...
   >
    ...
    >
        ...
        >
            ...
            <p className="my-5">
                Are you ready to achieve the body shape you has always wanted?
                We are ready to help your through that journey.
            </p>
        </motion.div>
        {/**FORM  AND IMAGE*/}
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
                ...
                onSubmit={onSubmit}
                method="POST"
                action="https//formsubmit.co/93fb353affd3c01d0ec3ac57a1428792"
                >
                    <input type="text"
